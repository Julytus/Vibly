...
import useMiniChatToggle from '../../hooks/useMiniChatToggle';

const MiniChatBox = () => {
    const { isOpen, toggleMiniChat } = useMiniChatToggle();
    
    return (
        <div className={`right-sidebar-mini ${!isOpen ? 'right-sidebar-close' : ''}`}>
            <div className="right-sidebar-panel p-0">
                <div className="card shadow-none m-0 h-100">
                    <div className="card-body px-0 pt-0">
                        ...
                        <div className="tabs">
                            <div
                                className="nav nav-tabs right-sidebar-tabs"
                        ...
                        <div className="media-height" data-scrollbar="init">
                            <div
                                className="tab-content right-sidebar-tabs-content"
                                id="right-sidebar-tabs"
                            >
                                <div
