...
const SidebarLogo = ({ isMini, toggleSidebarMode }) => {
    return (
        <div className="sidebar-header d-flex align-items-center justify-content-start position-relative">
            <Link to="/" className="d-flex align-items-center gap-2 iq-header-logo">
                ...
                <h3 className="logo-title" data-setting="app_name">Vibly</h3>
            </Link>
            <div className={`sidebar-toggle ${isMini ? 'mini' : ''}`} data-toggle="sidebar" data-active="true" onClick={toggleSidebarMode}>
