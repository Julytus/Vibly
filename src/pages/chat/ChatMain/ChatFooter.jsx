        ...
        <div className="card-footer px-3 py-3 border-top rounded-0">
            <form className="d-flex align-items-center" onSubmit={handleSubmit}>
                <div className="chat-attagement d-flex">
                    <a href="#" className="d-flex align-items-center pe-3"> <svg className="icon-24" width="24" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" className="d-flex align-items-center pe-3">
                ...
                <button type="submit" className="btn btn-primary d-flex align-items-center">
                    <svg className="icon-20" width="18" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
